...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/docmark-extension-jsonc
   cd docmark-extension-jsonc
   ```
...
```sh
https://github.com/flex-development/docmark-extension-jsonc/compare/main...$branch
```
